...
typedef enum {
	PROGRAM_TOKEN, NUM_TOKEN, CONST_TOKEN, VAR_TOKEN,
    BEGIN_TOKEN, END_TOKEN,IF_TOKEN, THEN_TOKEN,WHILE_TOKEN, 
    DO_TOKEN,READ_TOKEN, WRITE_TOKEN,PV_TOKEN, PT_TOKEN,
    PLUS_TOKEN, MOINS_TOKEN,MULT_TOKEN, DIV_TOKEN,VIR_TOKEN, 
    AFF_TOKEN, INF_TOKEN, INFEG_TOKEN, SUP_TOKEN, SUPEG_TOKEN,
    DIFF_TOKEN, PO_TOKEN,PF_TOKEN, FIN_TOKEN,ID_TOKEN, ERREUR_TOKEN,
    EOF_TOKEN, EG_TOKEN,COM_TOKEN,ELSE_TOKEN,REPEAT_TOKEN,
    UNTIL_TOKEN,FOR_TOKEN,CASE_TOKEN,INTO_TOKEN,DOWNTO_TOKEN, 
    DP_TOKEN,OF_TOKEN, ACC_TOKEN
} CODES_TOKENS;
...
typedef enum{
	ERR_CAR_INC, ERR_FIC_VID, ERR_PROGRAM, ERR_ID, ERR_PV, 
    ERR_PT, ERR_EGAL, ERR_NUM, ERR_CONST, ERR_VAR_BEGIN, 
    ERR_CONST_VAR_BEGIN, ERR_BEGIN, ERR_END, ERR_AFF, ERR_IF, 
    ERR_WHILE, ERR_DO, ERR_WRITE,  ERR_READ, ERR_THEN, ERR_PO, 
    ERR_PF,ERR_MOINS, ERR_PLUS, ERR_MULT, ERR_DIV, ERR_COND, 
    ERR_TERM, ERR_FACT, ERR_INF, ERR_SUP, ERR_SUPEG, ERR_INFEG, 
    ERR_DIFF, ERR_ACC, ERR_EXPR,ERR_ELSE,ERR_REPEAT,ERR_UNTIL,
    ERR_FOR,ERR_CASE, ERR_INTO,ERR_DOWNTO,ERR_DP,ERR_TOKEN,
    ERR_OF,ERR_INST,ERR_NOTEXISTID,ERR_EXISTID,ERR_CONSTCH,
    ERR_PROGD, ERR_PLEIN, ERR_AFFECT_ABS
	}ERREURS;
...
int OFFSET=-1;  // pour memoriser l'adresse de chaque identificateur
int MEM[1000]; // pour memoriser les valeurs des identificateurs
